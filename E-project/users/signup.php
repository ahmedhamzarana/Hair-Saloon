                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                       ...
                       <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingText" name="phone" placeholder="phone" required>
                        ...
                        <div class="form-floating mb-4">
                            <input type="file" class="form-control" id="floatingPassword" name="img" placeholder="choose file" required>
                            <label for="floatingPassword">Password</label>
                        </div>
                        <div class="form-floating mb-4">
...
if (isset($_POST['btnregister'])) {
    ...
    move_uploaded_file($tempimage, 'userimage/' . $filename);

    $query = "INSERT INTO `users`(`name`, `phone`, `email`, `password`, `role`, `img`) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $db->prepare($query);

    if ($stmt) {
        $stmt->bind_param("ssssss", $name, $phone, $email, $password, $role, $filename);
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                sendMail($row['email'], 'Thanks For Registration', $row['name'] . ' thank you for registering. Your application was received. More details will follow.');
